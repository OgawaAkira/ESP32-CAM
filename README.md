...
🚀 Como Usar
Conecte a ESP32-CAM com o cartão microSD inserido.
Grave o firmware na placa.
Ligue o dispositivo.
No celular ou computador, conecte-se à rede Wi‑Fi:
SSID: ESP32_Camera
Senha: 12345678
...
Ligar a ESP32-CAM
Conectar o celular à rede ESP32_Camera
Abrir http://192.168.4.1
Tocar em TIRAR FOTO
Visualizar a última imagem
Abrir a galeria
Baixar ou apagar fotos conforme necessário
🤝 Contribuições
